...
class CreateFilehub extends StatefulWidget {
  const CreateFilehub({Key? key}) : super(key: key);

  @override
  _CreateFilehubState createState() => _CreateFilehubState();
}

class _CreateFilehubState extends State<CreateFilehub> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Create FileHub'),
